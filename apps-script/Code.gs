...
// Cupo por comisión y por taller: 70 por comisión (9 comisiones × 70 =
// 630) y 75 por taller (8 talleres × 75 = 600) — cada persona elige una
// comisión Y un taller, así que la suma de cupos de cada lista por
// separado tiene que cubrir el total de asistentes esperado, con un
// margen chico. Las listas de nombres tienen que coincidir EXACTO con
...
const CUPO_POR_COMISION = 70;
const CUPO_POR_TALLER = 75;
